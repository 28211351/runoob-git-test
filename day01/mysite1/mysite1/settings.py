...
SECRET_KEY = 'django-insecure-7n9p4y#1zl2c4*i$aaoswu+u_0yl0wr+wk)cyliexa62coo4ra'
...
STATIC_ROOT = '/home/tarena/mysite1_static/static'
...
# 数据库缓存配置，需要手动执行创建my_cache_table表
CACHES = {
    'default': {
        'BACKEND': 'django.core.cache.backends.db.DatabaseCache',
        'LOCATION': 'my_cache_table',
        'TIMEOUT': 300,      # 缓存保存时间，单位秒
        'OPTIONS': {
